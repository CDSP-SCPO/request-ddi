...
class XMLParser:
    ...
    def parse_file(self, file, seen_invalid_dois):
        ...
        try:
            ...
            doi_tag = soup.find("IDNo", attrs={"agency": "DataCite"}) or soup.find(
                "IDNo"
            )
            ...
            for line in soup.find_all("var"):
                ...
                data.append(
                    [
                        ...
                        line.find("qstnLit").text.strip()
                        if line.find("qstnLit")
                        else "",
                        categories,
                        line.find("universe").text.strip()
                        if line.find("universe")
                        else "",
