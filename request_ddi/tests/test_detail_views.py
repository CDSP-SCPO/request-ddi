...
class QuestionDetailViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.conceptual_var = ConceptualVariable.objects.create(
            internal_label="AGE_CONCEPT", is_unique=False
        )
        ...
        cls.question = BindingSurveyRepresentedVariable.objects.create(
            variable=cls.variable, survey=cls.survey, variable_name="Q1"
        )
    ...
    def test_get_existing_question(self):
        ...
        response = self.client.get(reverse("request_ddi:question_detail", args=[self.question.id]))
    ...
    def test_get_nonexistent_question(self):
        ...
        response = self.client.get(reverse("request_ddi:question_detail", args=[9999]))
    ...
    def test_similar_questions(self):
        ...
        similar_question = BindingSurveyRepresentedVariable.objects.create(
            variable=self.variable, survey=self.survey, variable_name="Q2"
        )
